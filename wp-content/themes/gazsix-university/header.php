...
<header class="site-header">
    ...
    <div class="site-header__menu group">
        ...
        <ul>
            <li <?php if (is_page('about-us') or wp_get_post_parent_id(0)==12) echo 'class="current-menu-item"' ?>><a href="<?php echo esc_url(site_url('/about-us')) //wp_get_post_parent_id(0); 0 here means current page?>">About Us</a></li>
